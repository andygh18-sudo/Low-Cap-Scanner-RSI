...
def main():
    ...
    if btc_key not in keys:
        ...
        btc_msg=(f"🌐 GENERAL CRYPTO MARKET DIRECTION\n\n{btc_signal}\n\n₿ BTC PRICE: ${btc_price:,.2f}\nBTC 24h: {btc24:.2f}%\nBTC 7d: {btc7:.2f}%\n"
                 ...
                 f"\n💵 USDT DOMINANCE: {fmt(ctx['usdt_dominance_pct'])}%\n{ctx['usdt_dominance_trend']}\nUSDT Dominance 1D: {fmt(ctx['usdt_dominance_change_1d'])} percentage points\nUSDT Dominance 7D: {fmt(ctx['usdt_dominance_change_7d'])} percentage points\n"
